...
#define hwReadConfig(__pos) \
	eeprom_read_byte((uint8_t*)(__pos))
#define hwWriteConfig(__pos, __val) \
	eeprom_update_byte((uint8_t*)(__pos), (__val))
#define hwReadConfigBlock(__buf, __pos, __length) \
	eeprom_read_block((void*)(__buf), (void*)(__pos), (__length))
#define hwWriteConfigBlock(__buf, __pos, __length) \
	eeprom_update_block((void*)(__buf), (void*)(__pos), (__length))

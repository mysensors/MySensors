...
uint8_t hwReadConfig(int adr) { return NVRAM.read(adr); }

void hwWriteConfig(int adr, uint8_t value) { (void)NVRAM.write(adr, value); }
...
void hwWatchdogReset() { NRF_WDT->RR[0] = WDT_RR_RR_Reload; }
...
uint16_t hwCPUVoltage() { return 0; }

uint16_t hwCPUFrequency() { return F_CPU / 100000UL; }

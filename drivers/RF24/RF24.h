...
#define DEFAULT_RF24_CE_PIN		(9)		//!< DEFAULT CE PIN
#define DEFAULT_RF24_CS_PIN		(SS)	//!< DEFAULT CS PIN
#elif defined(ARDUINO_ARCH_ESP8266)
#define DEFAULT_RF24_CE_PIN		(4)		//!< DEFAULT CE PIN
#define DEFAULT_RF24_CS_PIN		(SS)	//!< DEFAULT CS PIN
#elif defined(ARDUINO_ARCH_SAMD)
#define DEFAULT_RF24_CE_PIN		(27)	//!< DEFAULT CE PIN
#define DEFAULT_RF24_CS_PIN		(3)		//!< DEFAULT CS PIN
#elif defined(LINUX_ARCH_RASPBERRYPI)
#define DEFAULT_RF24_CE_PIN		(22)	//!< DEFAULT CE PIN
#define DEFAULT_RF24_CS_PIN		(24)	//!< DEFAULT CS PIN
#else
#define DEFAULT_RF24_CE_PIN		(9)		//!< DEFAULT CE PIN
#define DEFAULT_RF24_CS_PIN		(SS)	//!< DEFAULT CS PIN
#endif

...
MyMessage msg_generic(0, V_LIGHT);
...
void presentation()
{
  ...
  Serial.println(metric ? F("Metric") : F("Imperial"));
  wait(LONG_WAIT);
...
#ifdef ID_S_MOISTURE
  Serial.println(F("  S_MOISTURE"));
  present(ID_S_MOISTURE, S_MOISTURE, "Basement Sensor");
  wait(SHORT_WAIT);
#endif

#ifdef ID_S_CUSTOM
  Serial.println(F("  S_CUSTOM"));
...
void loop()
{
  ...
  Serial.println(F("Send Battery Level"));
...
void door()
{
  ...
  if (randNumber <= 50) {
    ...
    //ID_S_DOOR,V_TRIPPED
    msg_generic.setSensor(ID_S_DOOR);
    msg_generic.setType(V_TRIPPED);
    send(msg_generic.set((int16_t)1));
  } else {
    Serial.println(F("Closed"));
    //ID_S_DOOR,V_TRIPPED
    msg_generic.setSensor(ID_S_DOOR);
    msg_generic.setType(V_TRIPPED);
    send(msg_generic.set((int16_t)0));
  }
#ifdef ID_S_ARMED
  ...
  //ID_S_DOOR,V_ARMED
  msg_generic.setSensor(ID_S_DOOR);
  msg_generic.setType(V_ARMED);
  send(msg_generic.set(isArmed));
#endif
}
#endif
...
void motion()
{
  ...
  if (randNumber <= 50) {
    ...
    msg_generic.setSensor(ID_S_MOTION);
    msg_generic.setType(V_TRIPPED);
    send(msg_generic.set(1));
  } else {
    Serial.println(F("Quiet"));
    //MyMessage msg_S_MOTION_T(ID_S_MOTION,V_TRIPPED);
    msg_generic.setSensor(ID_S_MOTION);
    msg_generic.setType(V_TRIPPED);
    send(msg_generic.set(0));
  }
...
void smoke()
{
  ...
  Serial.print(F("Smoke is: "));

  if (randNumber <= 50) {
    Serial.println(F("Active"));
    msg_generic.setSensor(ID_S_SMOKE);
    msg_generic.setType(V_TRIPPED);
    send(msg_generic.set(1));
  } else {
    Serial.println(F("Quiet"));
...
void light()
{
  ...
  Serial.println((isLightOn ? F("On") : F("Off")));
  msg_generic.setSensor(ID_S_LIGHT);
  msg_generic.setType(V_LIGHT);
  send(msg_generic.set(isLightOn));
...
void dimmer()
{
  ...
  Serial.print(F("Dimmer is set to: "));
  Serial.println(dimmerVal);
  msg_generic.setSensor(ID_S_DIMMER);
  msg_generic.setType(V_DIMMER);
  send(msg_generic.set(dimmerVal));
...
void cover()
{
  ...
  Serial.print(F("Cover is : "));

  if (coverState == 1) {
    Serial.println(F("Opening"));
    msg_generic.setSensor(ID_S_COVER);
    msg_generic.setType(V_UP);
    send(msg_generic.set(1));
  } else if (coverState == -1) {
    Serial.println(F("Closing"));
    msg_generic.setSensor(ID_S_COVER);
    msg_generic.setType(V_DOWN);
    send(msg_generic.set(0));
  } else {
    Serial.println(F("Idle"));
    msg_generic.setSensor(ID_S_COVER);
    msg_generic.setType(V_STOP);
    send(msg_generic.set(-1));
  }
  msg_generic.setSensor(ID_S_COVER);
  msg_generic.setType(V_VAR1);
  send(msg_generic.set(coverState));
}
#endif
...
void temp()
{
  ...
  msg_generic.setSensor(ID_S_TEMP);
  msg_generic.setType(V_TEMP);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 45)));
...
void hum()
{
  ...
  Serial.print(F("Humitidty is: "));
  Serial.println(randNumber);
  msg_generic.setSensor(ID_S_HUM);
  msg_generic.setType(V_HUM);
  send(msg_generic.set(randNumber));
...
void baro()
{
  ...
  msg_generic.setSensor(ID_S_BARO);
  msg_generic.setType(V_PRESSURE);
  send(msg_generic.set(pressure));

  Serial.print("Weather forecast: " );
  Serial.println(weather[forecast]);
  msg_generic.setSensor(ID_S_BARO);
  msg_generic.setType(V_FORECAST);
  send(msg_generic.set(weather[forecast]));
...
void wind()
{
  ...
  Serial.println(randNumber);
  msg_generic.setSensor(ID_S_WIND);
  msg_generic.setType(V_WIND);
  send(msg_generic.set(randNumber));

  Serial.print(F("Wind Gust is: "));
  Serial.println(randNumber + 10);
  msg_generic.setSensor(ID_S_WIND);
  msg_generic.setType(V_GUST);
  send(msg_generic.set(randNumber + 10));

  Serial.print(F("Wind Direction is: "));
  Serial.println(map(randNumber, 1, 100, 0, 360));
  msg_generic.setSensor(ID_S_WIND);
  msg_generic.setType(V_DIRECTION);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 360)));
...
void rain()
{
  ...
  Serial.print(F("Rain ammount  is: "));
  Serial.println(randNumber);
  msg_generic.setSensor(ID_S_RAIN);
  msg_generic.setType(V_RAIN);
  send(msg_generic.set(randNumber));

  Serial.print(F("Rain rate  is: "));
  Serial.println(randNumber / 60);
  msg_generic.setSensor(ID_S_RAIN);
  msg_generic.setType(V_RAINRATE);
  send(msg_generic.set(randNumber / 60, 1));
...
void uv()
{
  ...
  Serial.print(F("Ultra Violet level is: "));
  Serial.println(map(randNumber, 1, 100, 0, 15));
  msg_generic.setSensor(ID_S_UV);
  msg_generic.setType(V_UV);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 15)));
...
void weight()
{
  ...
  msg_generic.setSensor(ID_S_WEIGHT);
  msg_generic.setType(V_WEIGHT);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));
...
void power()
{
  ...
  Serial.print(F("Watt is: "));
  Serial.println(map(randNumber, 1, 100, 0, 150));
  msg_generic.setSensor(ID_S_POWER);
  msg_generic.setType(V_WATT);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));

  msg_generic.setSensor(ID_S_POWER);
  msg_generic.setType(V_KWH);
  Serial.print(F("KWH is: "));
  Serial.println(map(randNumber, 1, 100, 0, 150));
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));
...
void heater()
{
  ...
  Serial.print(F("Heater flow state is: "));
  Serial.println(heater_flow_state);
  msg_generic.setSensor(ID_S_HEATER);
  msg_generic.setType(V_HVAC_FLOW_STATE);
  send(msg_generic.set(heater_flow_state.c_str()));
  ...
  Serial.print(F("Heater Setpoint: "));
  Serial.println(heater_setpoint, 1);
  msg_generic.setSensor(ID_S_HEATER);
  msg_generic.setType(V_HVAC_SETPOINT_HEAT);
  send(msg_generic.set(heater_setpoint, 1));
}
#endif
...
void distance()
{
  ...
  Serial.println(map(randNumber, 1, 100, 0, 150));
  msg_generic.setSensor(ID_S_DISTANCE);
  msg_generic.setType(V_DISTANCE);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));
...
void light_level()
{
  ...
  Serial.print(F("Light is: "));
  Serial.println(map(randNumber, 1, 100, 0, 150));
  msg_generic.setSensor(ID_S_LIGHT_LEVEL);
  msg_generic.setType(V_LIGHT_LEVEL);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));
...
void lock()
{
  ...
  Serial.print(F("Lock is: "));
  Serial.println((isLocked ? F("Locked") : F("Unlocked")));
  msg_generic.setSensor(ID_S_LOCK);
  msg_generic.setType(V_LOCK_STATUS);
  send(msg_generic.set(isLocked));
...
void ir()
{
  ...
  Serial.print(F("Infrared is: "));
  Serial.println(irVal);
  msg_generic.setSensor(ID_S_IR);
  msg_generic.setType(V_IR_SEND);
  send(msg_generic.set(irVal));
  msg_generic.setSensor(ID_S_IR);
  msg_generic.setType(V_IR_RECEIVE);
  send(msg_generic.set(irVal));
...
void water()
{
  ...
  Serial.print(F("Water flow is: "));
  Serial.println(map(randNumber, 1, 100, 0, 150));
  msg_generic.setSensor(ID_S_WATER);
  msg_generic.setType(V_FLOW);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));

  Serial.print(F("Water volume is: "));
  Serial.println(map(randNumber, 1, 100, 0, 150));
  msg_generic.setSensor(ID_S_WATER);
  msg_generic.setType(V_VOLUME);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));
...
void air()
{
  ...
  Serial.print(F("Air Quality is: "));
  Serial.println(randNumber);
  msg_generic.setSensor(ID_S_AIR_QUALITY);
  msg_generic.setType(V_LEVEL);
  send(msg_generic.set(randNumber));
...
void dust()
{
  ...
  Serial.print(F("Dust level is: "));
  Serial.println(randNumber);
  msg_generic.setSensor(ID_S_DUST);
  msg_generic.setType(V_LEVEL);
  send(msg_generic.set(randNumber));
...
void scene()
{
  ...
  Serial.print(F("Scene is: "));
  Serial.println(scenes[sceneVal]);

  if (sceneValPrevious != sceneVal) {
    msg_generic.setSensor(ID_S_SCENE_CONTROLLER);
    msg_generic.setType(V_SCENE_OFF);
    send(msg_generic.set(sceneValPrevious));

    msg_generic.setSensor(ID_S_SCENE_CONTROLLER);
    msg_generic.setType(V_SCENE_ON);
    send(msg_generic.set(sceneVal));
...
void rgbLight()
{
  ...
  Serial.print(F("RGB Light state is: "));
  Serial.println(rgbState);
  msg_generic.setSensor(ID_S_RGB_LIGHT);
  msg_generic.setType(V_RGB);
  send(msg_generic.set(rgbState.c_str()));

  Serial.print(F("RGB Light Watt is: "));
  Serial.println(map(randNumber, 1, 100, 0, 150));
  msg_generic.setSensor(ID_S_RGB_LIGHT);
  msg_generic.setType(V_WATT);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));
...
void rgbwLight()
{
  ...
  Serial.print(F("RGBW Light state is: "));
  Serial.println(rgbwState);
  msg_generic.setSensor(ID_S_RGBW_LIGHT);
  msg_generic.setType(V_RGBW);
  send(msg_generic.set(rgbwState.c_str()));

  Serial.print(F("RGBW Light Watt is: "));
  Serial.println(map(randNumber, 1, 100, 0, 150));
  msg_generic.setSensor(ID_S_RGBW_LIGHT);
  msg_generic.setType(V_WATT);
  send(msg_generic.set(map(randNumber, 1, 100, 0, 150)));
...
void color()
{
  ...
  Serial.print(F("Color state is: "));
  Serial.println(colorState);
  msg_generic.setSensor(ID_S_COLOR_SENSOR);
  msg_generic.setType(V_RGB);
  send(msg_generic.set(colorState.c_str()));
...
void hvac()
{
  ...
  Serial.print(F("HVAC Set Point Heat is: "));
  Serial.println(hvac_SetPointHeat);
  msg_generic.setSensor(ID_S_HVAC);
  msg_generic.setType(V_HVAC_SETPOINT_HEAT);
  send(msg_generic.set(hvac_SetPointHeat, 1));

  Serial.print(F("HVAC Set Point Cool is: "));
  Serial.println(hvac_SetPointCool);
  msg_generic.setSensor(ID_S_HVAC);
  msg_generic.setType(V_HVAC_SETPOINT_COOL);
  send(msg_generic.set(hvac_SetPointCool, 1));

  Serial.print(F("HVAC Flow State is: "));
  Serial.println(hvac_FlowState);
  msg_generic.setSensor(ID_S_HVAC);
  msg_generic.setType(V_HVAC_FLOW_STATE);
  send(msg_generic.set(hvac_FlowState.c_str()));

  Serial.print(F("HVAC Flow Mode is: "));
  Serial.println(hvac_FlowMode);
  msg_generic.setSensor(ID_S_HVAC);
  msg_generic.setType(V_HVAC_FLOW_MODE);
  send(msg_generic.set(hvac_FlowMode.c_str()));

  Serial.print(F("HVAC Speed is: "));
  Serial.println(hvac_Speed);
  msg_generic.setSensor(ID_S_HVAC);
  msg_generic.setType(V_HVAC_SPEED);
  send(msg_generic.set(hvac_Speed.c_str()));
...
void multimeter()
{
  ...
  Serial.print(F("Impedance is: "));
  Serial.println(impedance);
  msg_generic.setSensor(ID_S_MULTIMETER);
  msg_generic.setType(V_IMPEDANCE);
  send(msg_generic.set(impedance));

  Serial.print(F("Voltage is: "));
  Serial.println(volt);
  msg_generic.setSensor(ID_S_MULTIMETER);
  msg_generic.setType(V_VOLTAGE);
  send(msg_generic.set(volt));

  Serial.print(F("Current is: "));
  Serial.println(amps);
  msg_generic.setSensor(ID_S_MULTIMETER);
  msg_generic.setType(V_CURRENT);

  send(msg_generic.set(amps));
...
void moisture()
{
  ...
  Serial.println(randNumber);
  msg_generic.setSensor(ID_S_MOISTURE);
  msg_generic.setType(V_LEVEL);
  send(msg_generic.set(randNumber));
...
void custom()
{
  ...
  Serial.print(F("Custom value is: "));
  Serial.println(randNumber);

  msg_generic.setSensor(ID_S_CUSTOM);
  msg_generic.setType(V_VAR1);
  send(msg_generic.set(randNumber));

  msg_generic.setSensor(ID_S_CUSTOM);
  msg_generic.setType(V_VAR2);
  send(msg_generic.set(randNumber));

  msg_generic.setSensor(ID_S_CUSTOM);
  msg_generic.setType(V_VAR3);
  send(msg_generic.set(randNumber));

  msg_generic.setSensor(ID_S_CUSTOM);
  msg_generic.setType(V_VAR4);
  send(msg_generic.set(randNumber));

  msg_generic.setSensor(ID_S_CUSTOM);
  msg_generic.setType(V_VAR5);
  send(msg_generic.set(randNumber));
...
void receive(const MyMessage &message)
{
  switch (message.type) {
    ...
    case V_ARMED:
      ...
      Serial.print(F("Incoming change for ID_S_ARMED:"));
    ...
    case V_STATUS: // V_LIGHT:
      ...
      if (message.sensor == ID_S_LIGHT) {
        ...
        Serial.print(F("Incoming change for ID_S_LIGHT:"));
        Serial.print(message.sensor);
        Serial.print(F(", New status: "));
        Serial.println((isLightOn ? F("On") : F("Off")));
        light(); // temp ack
    ...
    case V_DIMMER:
      ...
      Serial.print(F("Incoming change for ID_S_DIMMER:"));
      Serial.print(message.sensor);
      Serial.print(F(", New status: "));
    ...
    case V_UP:
      coverState = 1;
      Serial.print(F("Incoming change for ID_S_COVER:"));
      Serial.print(message.sensor);
      Serial.print(F(", New status: "));
      Serial.println("V_UP");
      cover(); // temp ack
    ...
    case V_HVAC_SETPOINT_HEAT:
      ...
      if (message.sensor == ID_S_HEATER) {
        ...
        Serial.print(F("Incoming set point for ID_S_HEATER:"));
        Serial.print(message.sensor);
        Serial.print(F(", New status: "));
        Serial.println(heater_setpoint, 1);
        heater();//temp ack
      ...
      if (message.sensor == ID_S_HVAC) {
        ...
        Serial.print(F("Incoming set point for ID_S_HVAC:"));
        Serial.print(message.sensor);
        Serial.print(F(", New status: "));
    ...
    case V_HVAC_FLOW_STATE:
      ...
      if (message.sensor == ID_S_HEATER) {
        ...
        Serial.print(F("Incoming flow state change for ID_S_HEATER:"));
        Serial.print(message.sensor);
        Serial.print(F(", New status: "));
        Serial.println(heater_flow_state);
        heater();//temp ack
    ...
    case V_LOCK_STATUS:
      ...
      Serial.print(F("Incoming change for ID_S_LOCK:"));
      Serial.print(message.sensor);
      Serial.print(F(", New status: "));
      Serial.println(message.getBool() ? F("Locked") : F("Unlocked"));
      lock(); //temp ack
      break;
#endif
    ...
    case V_IR_SEND:
      ...
      Serial.print(F("Incoming change for ID_S_IR:"));
      Serial.print(message.sensor);
      Serial.print(F(", New status: "));
      Serial.println(irVal);
      ir(); // temp ack
    ...
    case V_SCENE_ON:
      ...
      Serial.print(F("Incoming change for ID_S_SCENE_CONTROLLER:"));
      Serial.print(message.sensor);
      Serial.print(F(", New status: "));
    ...
    case V_RGB:
      ...
      Serial.print(F("Incoming flow state change for ID_S_RGB_LIGHT:"));
      Serial.print(message.sensor);
      Serial.print(F(", New status: "));
      Serial.println(rgbState);
      rgbLight(); // temp ack
    ...
    case V_RGBW:
      ...
      Serial.print(F("Incoming flow state change for ID_S_RGBW_LIGHT:"));
      Serial.print(message.sensor);
      Serial.print(F(", New status: "));
      Serial.println(rgbwState);
      rgbwLight();
    ...
    default:
      Serial.print(F("Unknown/UnImplemented message type: "));

	...
	try {
		...
		stage('Preparation') {
			checkout([$class: 'GitSCM', branches: [[name: '*/master']],
				extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'hardware/MySensors/avr']],
				userRemoteConfigs: [[url: 'https://github.com/mysensors/ArduinoHwAVR.git']]])
			checkout([$class: 'GitSCM', branches: [[name: '*/master']],
				extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'hardware/MySensors/samd']],
				userRemoteConfigs: [[url: 'https://github.com/mysensors/ArduinoHwSAMD.git']]])
			checkout([$class: 'GitSCM', branches: [[name: '*/master']],
				extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'hardware/MySensors/nRF5']],

...
#ifndef MyTransportNRF24ENCENC_h
#define MyTransportNRF24ENCENC_h
...
class MyTransportNRF24ENC : public MyTransport
{ 
public:
	MyTransportNRF24ENC(uint8_t ce=RF24_CE_PIN, uint8_t cs=RF24_CS_PIN, uint8_t paLevel=RF24_PA_LEVEL, uint8_t channel=RF24_CHANNEL, rf24_datarate_e datarate=RF24_DATARATE);
	bool init();
